...
BQRDefaultImageFactory::BQRDefaultImageFactory(QObject *parent) : BQRImageFactory(parent)
{

}
QImage *BQRDefaultImageFactory::buildImageFromCode(const BQRCode *code)
{
    if(!code->isReady())
        return 0;
